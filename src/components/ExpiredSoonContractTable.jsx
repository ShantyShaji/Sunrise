...
const ExpiredSoonContractTable = ({ contracts }) => {
  return (
    <div className="flex h-screen bg-gray-900 text-black">
      <AdminSidebar />
      <div className="flex-1 p-6 h-screen overflow-y-scroll bg-white">
        <div className="text-black">
          <h1 className="text-2xl font-semibold mt-10 lg:mt-0">Expired Soon Contracts</h1>
        </div>
...
export default ExpiredSoonContractTable;
